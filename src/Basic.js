...
const Basic = () => {
    ...
    return (
        <div className="basic-container">
            <button>HOME</button>
            {checked === 0 && <div><h1>What is basic strategy? </h1>
            ...
            {checked === 1 && <div><h1>Why play with basic strategy? </h1>
            ...
            {checked === 2 && <div><h1>So... back to the first question: what is basic strategy? </h1>
            ...
            {checked === 3 && <div><h1>Is that it? </h1>
            ...
            {checked === 4 && <div><h1>So...is <i>that </i>it? </h1>
